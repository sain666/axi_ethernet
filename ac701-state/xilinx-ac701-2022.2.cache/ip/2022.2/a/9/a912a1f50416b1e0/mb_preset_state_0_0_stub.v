...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, rst_n, data_in, nxt_state, reg_out, is_udp, 
  is_tcp)
/* synthesis syn_black_box black_box_pad_pin="clk,rst_n,data_in[31:0],nxt_state[3:0],reg_out[31:0],is_udp,is_tcp" */;
  input clk;
  input rst_n;
  input [31:0]data_in;
