...
HD_PWD='/tmp/jenkins-BUILDS-hw_designs_builds-2022.2-297_xilinx-ac701/bsps/xilinx-ac701-2022.2/hw_proj/xilinx-ac701-2022.2/xilinx-ac701-2022.2.runs/bd_b764_eth_buf_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_b764_eth_buf_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_b764_eth_buf_0.tcl
